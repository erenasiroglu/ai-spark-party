...
const appCss = "/assets/styles-Bs2KIYGn.css";
...
const $$splitComponentImporter = () => import("./index-NyiaI9qO.mjs");
const Route = createFileRoute("/")({
  head: () => ({
    meta: [{
      ...
      name: "description",
      content: "Tadado is the AI-powered social word game that generates infinite decks for your friend group. Fast rounds. No repeats. Pure chaos."
    }, {
      property: "og:title",
      content: "Tadado — The AI Word Game for Real-Life Chaos"
    }, {
      property: "og:description",
      content: "AI-generated party decks for the group chat era. Explain without saying. Laugh until you can't."
    }, {
      property: "og:type",
      content: "website"
    }, {
      property: "og:url",
      content: "https://ai-spark-party.lovable.app/"
    }, {
      name: "twitter:card",
    ...
    links: [{
      rel: "canonical",
      href: "https://ai-spark-party.lovable.app/"
    }],
    scripts: [{
      ...
      children: JSON.stringify({
        ...
        description: "Tadado is an AI-powered social word guessing game that generates infinite decks of forbidden-word cards for parties and friend groups.",
